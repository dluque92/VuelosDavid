...
import vuelos.ejb.CountryFacade;
 ...
 * @author david
 */
@WebServlet(name = "ServletListarVuelos", urlPatterns = {"/ServletListarVuelos"})
public class ServletListarVuelos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CityFacade> listaCiudades = (List) cityFacade.findAll();
        request.setAttribute("listaCiudades", listaCiudades);
        
        String[] listaPaises = request.getParameterValues("pais");
        request.setAttribute("listaPaises", listaPaises);
        
        HttpSession session = request.getSession();
        session.setAttribute("listaPaises", Arrays.asList(listaPaises));
